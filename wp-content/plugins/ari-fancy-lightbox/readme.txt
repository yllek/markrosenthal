...
Need a lightbox plugin to show various content on any device (from mobile to desktop)? ARI Fancy Lightbox is the right choice. 
...
> #### Want demo?
> Try the lightbox in action on [demo site](http://wp-quiz.ari-soft.com/plugins/wordpress-fancy-lightbox.html#demo)
...
> #### Need more features?
> Get [PRO version](http://wp-quiz.ari-soft.com/plugins/wordpress-fancy-lightbox.html#pricing).
...
**Do you like the plugin and want to say about it?** 

Write a review and rate it [here](https://wordpress.org/support/plugin/ari-fancy-lightbox/reviews/).

**Are interested in other our WordPress plugins?** 

Check [ARI Stream Quiz](https://wordpress.org/plugins/ari-stream-quiz/) - WordPress Viral Quiz plugin, 
[Contact Form 7 Connector](https://wordpress.org/plugins/ari-cf7-connector/) integrates CF7 with MailChimp and MailerLite,
[ARI Adminer](https://wordpress.org/plugins/ari-adminer/) - WordPress database management plugin.


== Installation ==

1. Open 'Plugin -> Add New' screen in admin part of your WordPress site, type 'ARI Fancy Lightbox' in search box and click 'Install Now' button to install the plugin or use 'Upload Plugin' button on 'Plugins -> Add New' screen to upload `ari-fancy-lightbox.zip` file and install the plugin
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Use the 'ARI Fancy Lightbox' screen to configure the plugin.


== Frequently Asked Questions ==

= Where can I see the plugin in action?
On our [demo site](http://wp-quiz.ari-soft.com/plugins/wordpress-fancy-lightbox.html#demo)

= Is a detailed documentation available? =
Sure, it is available [here](http://www.ari-soft.com/docs/wordpress/ari-fancy-lightbox/v1/en/index.html).

= Is the extension compatible with my theme? =
"ARI Fancy Lightbox" should work fine with any theme. If any problem occurs, feel free to [contact us](http://www.ari-soft.com/ARI-Fancy-Lightbox/) and we will resolve the problem ASAP.


== Screenshots ==
1. Lightbox - Image gallery
1. Lightbox - Image gallery with thumbnails
1. Lightbox - Open YouTube video
1. ARI Fancy Lightbox - Settings - Integration tab
1. ARI Fancy Lightbox - Settings - Lightbox tab
1. ARI Fancy Lightbox - Settings - Style tab
...
* Add "Load scripts in footer" option
